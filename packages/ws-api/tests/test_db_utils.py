"""Tests for ws_api.db.utils — register_job, get_active_replacements, etc."""
import pytest
from sqlmodel import Session

from ws_api.db.engine import engine
from ws_api.db.models import Job, Replacement, InitialPrompt, JobStatus
from ws_api.db.utils import (
    register_job,

"""Tests for ws-api REST endpoints."""
import os
import pytest
...
def test_auth_blocks_without_key(test_app):
    ...
    from fastapi.testclient import TestClient
    with patch("ws_api.auth.get_api_key", return_value="required"):
...
def test_sanitize_filename():
    from ws_api.endpoints import sanitize_filename

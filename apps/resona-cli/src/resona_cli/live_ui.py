"""
Resona Live TUI: Live transcription with real-time display.
...
class WSLiveApp(MicRecApp):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="main_container"):
            with Horizontal(id="controls_container"):
                ...
                yield Button("Clear", id="clear_results_button", variant="warning", classes="control_element")
                yield Button("Logs", id="clear_logs_button", variant="warning", classes="control_element")
    ...
    async def on_mount(self) -> None:
        ...
        self.log_msg("Resona Live ready. Press Record to start live transcription.")
